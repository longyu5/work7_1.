...
public class MyContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.work7_1.provider";
...
//        throw new UnsupportedOperationException("Not yet implemented");
        switch (uriMatcher.match(uri)){
            case contacts_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.work7_1.provider.contacts";
            case contacts_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.work7_1.provider.contacts";
        }
        return null;
    }
